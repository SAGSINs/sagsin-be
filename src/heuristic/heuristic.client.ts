...
const heuristicProto: any = grpc.loadPackageDefinition(heuristicPackageDef).heuristic;
...
const ALGORITHM_PROTO_PATH = join(__dirname, '../../proto/algorithm_stream.proto');
...
const algorithmProto: any = grpc.loadPackageDefinition(algorithmPackageDef).heuristic;
